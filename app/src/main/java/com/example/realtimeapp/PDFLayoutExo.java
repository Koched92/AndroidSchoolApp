...
public class PDFLayoutExo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pdflayout_exo);
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                for (DataSnapshot childSnapshot: dataSnapshot.getChildren()){
                                    ...
                                    if(childSnapshot.getKey().equals(userID)) {
                                        String value = childSnapshot.child(cours.replaceAll("\\s+","")).child(c.replaceAll("\\s+","")).child("pdfExo").getValue(String.class);
                                        text1.setText(value);
